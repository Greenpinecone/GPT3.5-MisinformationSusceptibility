...
class ModelEvaluation(Base):
    ...
    helpful_score = Column(Integer, default=0)
    honest_score = Column(Integer, default=0)
    harmless_score = Column(Integer, default=0)
    created_at = Column(DateTime, default=func.now())
...
class DataPointEvaluation(Base):
    ...
    coherence_score = Column(Integer, default=0.0)
    # 1-10 score for relevance
    relevance_score = Column(Integer, default=0.0)
